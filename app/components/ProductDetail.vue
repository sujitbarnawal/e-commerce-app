...
<template>
    <div class="">
        ...
        <div class="flex  flex-col lg:flex-row  gap-4">
            ...
            <img class="max-lg:mx-auto w-[320px] h-[320px] object-cover " :src="product.image" alt="product_image">
            <div class="flex flex-col">
                ...
                <p class="mt-2 text-2xl font-semibold">Ratings: <span class="text-gray-600 font-light"> {{
                        product.rating_count }}</span></p>
                <div class="flex mt-2 text-4xl">
                    <span v-for="i in 5" :class="i <= product.rating_rate! ? 'text-yellow-400' : ''">★</span>
                </div>
